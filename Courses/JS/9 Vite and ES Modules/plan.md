...
0. Разнести все по модулям
1. Реализовать модальное окно с сообщениями об ошибках вместо alert-a
2. Чекбокс можно сделать кастомный
3. Select можно сделать кастомный
